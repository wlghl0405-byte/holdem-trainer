...
console.log('  · 프로 vs 하수:', JSON.stringify(r1));
ok(r1.pro > r1.easy, '프로 2명이 하수 2명보다 많이 땀');
const r2 = twice(['pro', 'pro', 'normal', 'normal'], 400);
console.log('  · 프로 vs 중수:', JSON.stringify(r2));
ok(r2.pro > r2.normal, '프로가 중수보다 많이 땀');
const r3 = twice(['hard', 'hard', 'easy', 'easy'], 400);
console.log('  · 고수 vs 하수:', JSON.stringify(r3));
ok(r3.hard > r3.easy, '고수가 하수보다 많이 땀');
